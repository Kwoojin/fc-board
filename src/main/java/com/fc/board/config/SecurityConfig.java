...
public class SecurityConfig {
    ...
    public OAuth2UserService<OAuth2UserRequest, OAuth2User> oAuth2UserService(
        ...
        return userRequest -> {
            ...
            final String providerId = String.valueOf(kakaoResponse.getId());

            final String username = String.format("%s_%s", registrationId, providerId);
            final String dummyPassword = passwordEncoder.encode("{bcrypt}dummy");
