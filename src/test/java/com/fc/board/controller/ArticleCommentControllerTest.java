...
class ArticleCommentControllerTest {
    ...
    @Autowired
    public ArticleCommentControllerTest(MockMvc mvc, FormDataEncoder formDataEncoder) {
        this.mvc = mvc;
    ...
    @WithUserDetails(value = "woojinTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
